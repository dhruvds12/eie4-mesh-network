...
// SemaphoreHandle_t LoRaManager::radioSemaphore = NULL;

// LoRaManager::LoRaManager(DisplayManager &dispManager)
//     : display(dispManager), transmitFlag(false)
// {
//     // Create the SX1262 configuration instance here.
//     // The configuration module will create and own the radio instance.
//     sx1262Config = new SX1262Config(8, 14, 12, 13);
// }

// void LoRaManager::begin(float freq, float bw, uint8_t sf, uint8_t cr, uint8_t syncWord,
//                         int8_t power, uint16_t preambleLength, float tcxoVoltage, bool useRegulatorLDO)
// {
//     Serial.println(F("[LoRaManager] Configuring SX1262 radio..."));
//     display.displayNewString(0, 0, "[LoRaManager] Initializing radio...");

//     // Delegate initialization to the SX1262Config module.
//     int state = sx1262Config->init(freq, bw, sf, cr, syncWord, power, preambleLength, tcxoVoltage, useRegulatorLDO);
//     if (state == RADIOLIB_ERR_NONE) {
//         Serial.println(F("[LoRaManager] Radio init success!"));
//         display.displayNewString(0, 0, "LoRa init OK");
//     } else {
//         Serial.printf("[LoRaManager] Radio init failed, code %d\n", state);
//         display.displayNewString(0, 0, "LoRa init failed");
//         while (true) { delay(10); }
//     }
...
//         if (radioSemaphore == NULL) {
//             Serial.println("[LoRaManager] ERROR: Could not create radioSemaphore");
//             while (true) { delay(10); }
//         }
//     }
...
//     // Set the interrupt callback using the config module.
//     sx1262Config->setDio1Callback(recievedPacketISR);
...
// ICACHE_RAM_ATTR
// #endif
// void LoRaManager::recievedPacketISR(void)
// {
//     BaseType_t xHigherPriorityTaskWoken = pdFALSE;
//     // Signal the semaphore; you could also use a task notification
