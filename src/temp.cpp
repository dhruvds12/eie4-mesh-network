...
//   displayManager.displayNewString(0, 0, "[SX1262] Initializing ... ");
//   int state = radio.begin(868.0F, 125.0F, 9u, 7u, 18u, 10, 8u);
//   if (state == RADIOLIB_ERR_NONE)
//   {
//     Serial.println(F("success!"));
//     displayManager.displayNewString(0, 0, "success!");
//   }
//   else
//   {
...
//     displayManager.displayNewString(0, 0, error.c_str());
//     while (true)
//     {
//       delay(10);
//     }
...
//   transmitFlag = true;
//   displayManager.displayString(0, 0, "Sending first packet ... ");
// #else
...
//   {
//     Serial.println(F("success!"));
//     displayManager.displayNewString(0, 0, "Listening ... ");
//   }
//   else
//   {
//     Serial.print(F("failed, code "));
...
//         displayManager.displayString(0, 40, "transmission finished!");
//       }
//       else
//       {
//         Serial.print(F("failed, code "));
...
//         displayManager.displayString(0, 0, error.c_str());
//       }
